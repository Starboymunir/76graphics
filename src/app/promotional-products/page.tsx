...
export const metadata: Metadata = {
  title: "Custom Promotional Products | 76 Graphics",
  description:
    "Custom promotional products that keep your brand in people's hands. Business cards, branded apparel, stickers, packaging, and more from 76 Graphics.",
};

const INCLUDES = [
  "Business Cards & Stationery",
  "Branded Apparel & T-Shirts",
  "Stickers & Labels",
  "Custom Packaging",
  "Pens, Mugs & Branded Goods",
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative bg-[#061e31] brand-stars-bg pt-36 pb-24 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-8 lg:px-14 relative z-10">
          ...
          >
            Custom Products That Keep
            <span
              className="block"
              style={{ color: "transparent", WebkitTextStroke: "2px #b32025" }}
            >
              Your Brand in People&apos;s Hands
            </span>
          </h1>
          <p
            ...
            style={{ fontFamily: "'Inter', sans-serif" }}
          >
            Branded merchandise isn&apos;t just swag — it&apos;s a marketing tool. We help you create
            products that people actually keep and use, keeping your brand top of mind
            ...
            <div className="space-y-6">
              <div className="bg-[#061e31] border border-white/10 p-8">
                ...
                <p
                  ...
                  style={{ fontFamily: "'Inter', sans-serif" }}
                >
                  Unlike digital ads that disappear, branded products stick around. A quality
                  pen, t-shirt, or mug with your logo gets used repeatedly — each use is a
                  free marketing impression for your brand.
                </p>
              </div>
              ...
              <div className="bg-[#b32025]/10 border border-[#b32025]/25 p-8">
                <p
                  ...
                  style={{ fontFamily: "'Inter', sans-serif" }}
                >
                  &ldquo;Promotional products are the only advertising medium that makes the
                  recipient say &lsquo;thank you.&rsquo;&rdquo;
                </p>
                <p
